(function (global, factory) {
	...
	function sortableHandle(WrappedComponent) {
	  ...
	  return _class = function (_React$Component) {
	    ...
	    var _super = _createSuper$2(WithSortableHandle);
	    function WithSortableHandle() {
	      ...
	      _defineProperty(_assertThisInitialized(_this), "wrappedInstance", React__namespace.createRef());
	      return _this;
	    }
	  ...
	  }(React__namespace.Component), _defineProperty(_class, "displayName", provideDisplayName('sortableHandle', WrappedComponent)), _class;
	}
	...
	function sortableContainer(WrappedComponent) {
	        ...
	        try {
	          ...
	          var _temp5 = function () {
	            if (active) {
	              ...
	              return _temp7 && _temp7.then ? _temp7.then(_temp6) : _temp6(_temp7);
	            }
	          }();
	  ...
	  }(React__namespace.Component), _defineProperty(_class, "displayName", provideDisplayName('sortableList', WrappedComponent)), _defineProperty(_class, "defaultProps", defaultProps), _defineProperty(_class, "propTypes", propTypes$1), _class;
	}
	...
	function sortableElement(WrappedComponent) {
	  ...
	  }(React__namespace.Component), _defineProperty(_class, "displayName", provideDisplayName('sortableElement', WrappedComponent)), _defineProperty(_class, "contextType", SortableContext), _defineProperty(_class, "propTypes", propTypes), _defineProperty(_class, "defaultProps", {
	    collection: 0
	  }), _class;
	}
