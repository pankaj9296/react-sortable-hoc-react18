...
function sortableContainer(WrappedComponent) {
  ...
  }(React.Component), _defineProperty(_class, "displayName", provideDisplayName('sortableList', WrappedComponent)), _defineProperty(_class, "defaultProps", defaultProps), _defineProperty(_class, "propTypes", propTypes$1), _class;
}
...
function sortableElement(WrappedComponent) {
  ...
  }(React.Component), _defineProperty(_class, "displayName", provideDisplayName('sortableElement', WrappedComponent)), _defineProperty(_class, "contextType", SortableContext), _defineProperty(_class, "propTypes", propTypes), _defineProperty(_class, "defaultProps", {
    collection: 0
  }), _class;
}
